...
function(){this.connection.stop();this.connection=null}})();Violet.UserStream=function(b){b=Violet.Streaming(b);b.base_uri="https://userstream.twitter.com/1.1/";b.endpoint="user";return b};Violet.init=function Class(a){if(!(this instanceof Class))return new Class(a);this.base_uri="https://api.twitter.com/1.1/";this.consumer_key=a.consumer_key;this.consumer_secret=a.consumer_secret;this.access_token=a.access_token||"";this.access_token_secret=a.access_token_secret||"";this.initialize()};
(function(){Violet.init.prototype.initialize=function(){this.oauth=Violet.OAuth({consumer_key:this.consumer_key,consumer_secret:this.consumer_secret,access_token:this.access_token,access_token_secret:this.access_token_secret});this.streaming=this.userstream=Violet.UserStream(this.oauth);this.request=Violet.Request.request.bind(this)}})();
