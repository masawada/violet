...
(function(){Violet.init.prototype.initialize=function(){this.oauth=Violet.OAuth({consumer_key:this.consumer_key,consumer_secret:this.consumer_secret,access_token:this.access_token,access_token_secret:this.access_token_secret});this.streaming=Violet.Streaming(this.oauth);this.request=Violet.Request.request.bind(this)}})();
