...
function(){this.connection.stop();this.connection=null}})();Violet.UserStream=function(b){b=Violet.Streaming(b);b.base_uri="https://userstream.twitter.com/1.1/";b.endpoint="user";return b};Violet.FilterStream=function(b){b=Violet.Streaming(b);b.base_uri="https://stream.twitter.com/1.1/";b.endpoint="statuses/filter";return b};Violet.PublicStream=function(b){b=Violet.Streaming(b);b.base_uri="https://userstream.twitter.com/1.1/";b.endpoint="statuses/sample";return b};
