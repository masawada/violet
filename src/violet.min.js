var Violet={Util:{}};Violet.Util.uri_encode=function(b){return encodeURIComponent(b).replace(/[!'()]/g,escape).replace(/\*/g,"%2A")};Violet.Util.mergeHash=function(){var b=arguments.length,a,e,c={};for(a=0;a<b;a++){var d=arguments[a];for(e in d)d.hasOwnProperty(e)&&(c[e]=d[e])}return c};Violet.Util.hashLength=function(b){var a,e=0;for(a in b)b.hasOwnProperty(a)&&e++;return e};
...
function(){this.request.abort()};b.setOAuthHeader=function(a){var b="",c=[];for(b in a)a.hasOwnProperty(b)&&(c[c.length]=b+'="'+a[b]+'"');this.authorization_header="OAuth "+c.join(", ")};b.postBody=function(){if("GET"===this.method||0===this.post_data.length)return null;var a="",b=this.post_data,c=[];for(a in b)b.hasOwnProperty(a)&&c.push(a+"="+Violet.Util.uri_encode(b[a]));return c.join("&")}})();
...
(function(){var b=Violet.OAuth.prototype;b.obtainAuthorizeURI=function(a,b){var c=Violet.HTTPClient({uri:"https://api.twitter.com/oauth/request_token",method:"POST"}),d={oauth_callback:"oob",oauth_consumer_key:this.consumer_key,oauth_nonce:this.generateNonce(32),oauth_signature_method:"HMAC-SHA1",oauth_timestamp:String(Math.floor(new Date/1E3)),oauth_version:"1.0"};d.oauth_signature=this.generateSignature("POST","https://api.twitter.com/oauth/request_token",d,"");c.setOAuthHeader(d);c.onsuccess=function(b){b=
b.responseText.split("&");var d,c=b.length,e={};for(d=0;d<c;d++){var h=b[d].split("=");e[h[0]]=h[1]}this.oauth_token=e.oauth_token;this.oauth_token_secret=e.oauth_token_secret;a("https://api.twitter.com/oauth/authorize?oauth_token="+e.oauth_token)}.bind(this);c.onerror=b;c.start()};b.obtainAccessToken=function(a,b,c){var d=Violet.HTTPClient({uri:"https://api.twitter.com/oauth/access_token",method:"POST"});a={oauth_consumer_key:this.consumer_key,oauth_nonce:this.generateNonce(32),oauth_signature_method:"HMAC-SHA1",
oauth_timestamp:String(Math.floor(new Date/1E3)),oauth_token:this.oauth_token,oauth_verifier:a,oauth_version:"1.0"};a.oauth_signature=this.generateSignature("POST","https://api.twitter.com/oauth/access_token",a,this.oauth_token_secret);d.setOAuthHeader(a);d.onsuccess=function(a){a=a.responseText.split("&");var d,c=a.length,l={};for(d=0;d<c;d++){var h=a[d].split("=");l[h[0]]=h[1]}this.access_token=l.access_token;this.access_token_secret=l.access_token_secret;b(l)}.bind(this);d.onerror=c;d.start()};
...
Violet.Request.request=function(b,a,e,c){var d=Violet.Request.generateRequestInfo(b,a);b=d.method;a=d.uri;var f=d.query;if(null===b)return!1;d=Violet.HTTPClient({method:b,uri:a+d.get_data});d.setOAuthHeader(this.oauth.obtainOAuthParams(b,a,f));d.onsuccess=e;d.onerror=c;"POST"===b&&(d.post_data=f);d.start()};
Violet.Request.generateRequestInfo=function(b,a){var e=Violet.Endpoints.method(b),c="";-1!==Violet.Endpoints.to_replace_id_none.indexOf(b)?b=b.replace(/\/\:id$/,""):-1!==Violet.Endpoints.to_replace_id.indexOf(b)?(b.replace(":id",a.id),delete a.id):-1!==Violet.Endpoints.to_replace_slug.indexOf(b)?(b.replace(":slug",a.slug),delete a.slug):-1!==Violet.Endpoints.to_replace_place_id.indexOf(b)&&(b.replace(":place_id",a.place_id),delete a.place_id);if("GET"===e&&0<Violet.Util.hashLength(a)){var c="",d=
[];for(c in a)a.hasOwnProperty(c)&&d.push(c+"="+Violet.Util.uri_encode(a[c]));c="?"+d.join("&")}return{method:e,uri:"https://api.twitter.com/1.1/"+b+".json",query:a,get_data:c}};Violet.Streaming=function Class(a){if(!(this instanceof Class))return new Class(a);this.oauth=a};
(function(){var b=Violet.Streaming.prototype;b.start=function(a,b){var c=Violet.HTTPClient({method:"GET",uri:"https://userstream.twitter.com/1.1/user.json"});c.setOAuthHeader(this.oauth.obtainOAuthParams("GET","https://userstream.twitter.com/1.1/user.json"));c.onloading=function(b){b=b.responseText.split("\r\n");if(!b[b.length-2])return!1;a(JSON.parse(b[b.length-2]))};c.onerror=b;c.start();this.connection=c};b.stop=function(){this.connection.stop();this.connection=null}})();
...
(function(){Violet.init.prototype.initialize=function(){this.oauth=Violet.OAuth({consumer_key:consumer_key,consumer_secret:consumer_secret,access_token:access_token,access_token_secret:access_token_secret});this.streaming=Violet.Streaming(this.oauth);this.request=Violet.Request.request.bind(this)}})();
